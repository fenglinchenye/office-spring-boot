 ...
 * @author freedo
 */
public class PrimaryIndexVerifyHandler implements IExcelVerifyHandler {
    ...
    @Override
    public synchronized ExcelVerifyHandlerResult verifyHandler(Object obj) {
        ...
        if (errorMessageJoiner.length()!=0){
            return new ExcelVerifyHandlerResult(false,errorMessageJoiner.toString());
        }
        return new ExcelVerifyHandlerResult(true);
    }
}
